 ...
 * Ported from the previous static site's assets/js/data.js. Every list here
 * renders itself; nothing below is hard-coded into a component.
 */
...
export const expertise = [
  ...
  },
  {
    ...
    items: ['AutoCAD', 'ArcGIS', 'WaterGEMS', 'SewerGEMS', 'MS Project', 'MS Excel', 'MS Visio', 'Google Earth Pro'],
  },
  {
    icon: 'chart',
    title: 'Digital & Data',
    items: ['Excel VBA', 'Power Query', 'Power Pivot', 'KoboToolbox', 'SW Maps', 'Data Visualization', 'Dashboard Development'],
  },
  {
    icon: 'spark',
    title: 'Technology',
    items: ['AI Tools', 'Vibe Coding', 'Web Development', 'Automation', 'Python', 'Git / GitHub', 'AI-assisted development'],
  },
];
...
export const projectCategories = [
  'All', 'Infrastructure Engineering', 'Project Monitoring', 'Field Data', 'GIS & Mapping', 'Digital Engineering',
];
